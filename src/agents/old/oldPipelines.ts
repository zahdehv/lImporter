...
import { geminiPREP } from "./generatePromptExternal";
import { reActAgentClaimI } from "../../agents/old/ClaimInstAgent";
import { reActAgentDirect } from "../../agents/old/DirectAgent";
import { reActLiteAgent } from "../../agents/old/LiteDEF";
import { reActLiteAgentTEST } from "../../agents/old/LiteTESTMEM";
import { reActDefaultAgent } from "../../agents/old/DefaultAgent";
import AutoFilePlugin from "src/main";
import { FileItem } from "src/utils/fileUploader";
import { preProcessor } from "../../utils/preprocessInput";
...
export class DirectPipe extends Pipeline {
    ...
    async call(prompt: string, files: FileItem[], signal: AbortSignal){
        const msgbld = new preProcessor(this.plugin);
