...
3. seguido de un tag <claims>, escribe un conjunto de hechos (claims made) mencionados o incluidos en el pdf.
...
// `},
        ...
        const inst0 = txt.split("<claims>");
        const inst1 = inst0[inst0.length - 1].split("</claims>");
